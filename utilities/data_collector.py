...
def parse_args():
    ...
    parser.add_argument("-i", "--interval", type=float, default=3.0, help="Time in seconds between captures")
...
def main():
    ...
    with dai.Pipeline(device) as pipeline:
        ...
        while pipeline.isRunning():
            ...
            if latestLeft and latestRight and latestRgb and (time.time() - last_capture_time > args.interval):
